...
@interface practice1Object : KrollCoverageObject {
#else
@interface practice1Object : KrollObject {
#endif
@private
...
extern NSString * practice1$ModuleRequireFormat;
