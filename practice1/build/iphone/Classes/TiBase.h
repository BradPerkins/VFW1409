...
// in simulator we redefine to format for practice1 Developer console
...
{\
	NSString * exceptionName = [@"org.practice1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.practice1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIpractice1NativeItemNone = -1, 
	UIpractice1NativeItemSpinner = -2,
	UIpractice1NativeItemProgressBar = -3,
	
	UIpractice1NativeItemSlider = -4,
	UIpractice1NativeItemSwitch = -5,
	UIpractice1NativeItemMultiButton = -6,
	UIpractice1NativeItemSegmented = -7,
	
	UIpractice1NativeItemTextView = -8,
	UIpractice1NativeItemTextField = -9,
	UIpractice1NativeItemSearchBar = -10,
	
	UIpractice1NativeItemPicker = -11,
	UIpractice1NativeItemDatePicker = -12,
	
	UIpractice1NativeItemInfoLight = -13,
	UIpractice1NativeItemInfoDark = -14,
	
	UIpractice1NativeItemDisclosure = -15,
	
	UIpractice1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all practice1 instances of
