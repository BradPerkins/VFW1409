...
/**
 The base class for all practice1 modules
 */
...
/**
 practice1 Platform calls this method on startup.
 */
-(void)startup;

/**
 practice1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 practice1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 practice1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 practice1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
