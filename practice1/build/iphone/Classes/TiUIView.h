...
/**
 Base class for all practice1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the practice1 view hierarchy (such as wrapped iOS UIViews) was touched.
