...
//@interface practice1Object : NSObject
//@end

@interface practice1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[practice1Object class]])
		{
			for (NSString *key in [[(practice1Object*)o modules] allKeys])
			{
